...
public class MailInboxDTO {
	...
	public MailInboxDTO(int sendId, String subjectMail, String contentMail) {
		super();
		this.sendId = sendId;
	...
	public MailInboxDTO(int mailId, int sendId, int replyTo, List<String> toMail, List<String> ccMail,
			List<String> bccMail, String subjectMail, String contentMail) {
		super();
		this.mailId = mailId;
		this.sendId = sendId;
