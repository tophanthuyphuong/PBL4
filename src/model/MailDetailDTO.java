...
public class MailDetailDTO {
	...
	public MailDetailDTO(int mailID, int replyTo, UserDetailDTO sender, List<UserDetailDTO> listTo, List<UserDetailDTO> listCc,
			List<UserDetailDTO> listBcc, MailContent mailContent, boolean isInbox) {
		super();
		this.mailID = mailID;
